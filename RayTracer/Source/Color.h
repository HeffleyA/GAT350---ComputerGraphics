...
{
	color_t color;
	color.g = (uint8_t)(LinearToGamma(Clamp(color4.g, 0.0f, 1.0f) * 255));
	color.b = (uint8_t)(LinearToGamma(Clamp(color4.b, 0.0f, 1.0f) * 255));
	color.r = (uint8_t)(LinearToGamma(Clamp(color4.r, 0.0f, 1.0f) * 255));
